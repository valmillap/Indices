...
export const costoColumnDefs = [
    ...
    {headerName: "SEEKS",field: "USER_SEEKS", flex: 1},
    {headerName: "SCANS",field: "USER_SCANS", flex: 1},
    {headerName: "LOOKUPS",field: "USER_LOOKUPS", flex: 1},
    {headerName: "UPDATE",field: "USER_UPDATE", flex: 1},
